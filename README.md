...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/throbbing-king-f1c3)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/throbbing-king-f1c3
```

A live public deployment of this template is available at [https://throbbing-king-f1c3.templates.workers.dev](https://throbbing-king-f1c3.templates.workers.dev)
